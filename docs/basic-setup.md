...
To add a client you should use the `multi:oauth2:create-client` command.
...
Usage:
  multi:oauth2:create-client [options] [--] [<identifier> [<secret>]]
...
To update a client you should use the `multi:oauth2:update-client` command.
...
Usage:
  multi:oauth2:update-client [options] [--] <identifier>
...
```sh
$ bin/console multi:oauth2:update-client --grant-type client_credentials --grant-type password foo
```
...
```sh
$ bin/console multi:oauth2:update-client --scope create --scope read foo
```

### Delete a client
To delete a client you should use the `multi:oauth2:delete-client` command.
...
Usage:
  multi:oauth2:delete-client <identifier>
...
### List clients
To list clients you should use the `multi:oauth2:list-clients` command.
...
Usage:
  multi:oauth2:list-clients [options]
...
To clear expired access and refresh tokens and auth codes you can use the `multi:oauth2:clear-expired-tokens` command.
...
Usage:
  multi:oauth2:clear-expired-tokens [options]
